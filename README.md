...
> module **compiles against nginx 1.31.6, loads, and passes a full live handshake**
...
export NGINX_SOURCE_DIR=/path/to/nginx-1.31.6
...
| Module builds against nginx 1.31.6 & loads (glibc + musl, amd64 + arm64) | module-build + nginx-smoke green for every libc×arch |
